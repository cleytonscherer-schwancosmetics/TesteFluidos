...
public class TesteFluidosFrame extends JInternalFrame {
	...
	private void criar_LotCmp() {
		...
		cbLotCmp.addActionListener(new ActionListener() { 
			public void actionPerformed(ActionEvent evt) {
				
				String lotCmp = (String) cbLotCmp.getSelectedItem(); 
				testeFluidos.setLotCmp(lotCmp);
				
				//if (cbLotCmp.getSelectedIndex() == 0) {// opção 1 no caso "COMBO 1"	                  
	            //}
			} 
		});
	}
	...
	private void adicionar() {
		...
		this.testeFluidos.setCodOri("45");
